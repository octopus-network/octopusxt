            ...
            impl<'a, T: ::subxt::Config> StorageApi<'a, T> {
                ...
                > {
                    if self.client.metadata().storage_hash::<Events>()?
                        == [
                            40u8, 141u8, 153u8, 65u8, 212u8, 45u8, 210u8, 213u8, 56u8, 80u8, 226u8,
                            228u8, 105u8, 14u8, 119u8, 36u8, 30u8, 12u8, 133u8, 202u8, 135u8,
                            104u8, 151u8, 123u8, 21u8, 88u8, 117u8, 41u8, 62u8, 115u8, 121u8,
                            125u8,
                        ]
                    {
                        let entry = Events;
                ...
                X: ::subxt::extrinsic::ExtrinsicParams<T>,
            {
                ...
                > {
                    if self.client.metadata().call_hash::<Sudo>()?
                        == [
                            123u8, 142u8, 197u8, 35u8, 190u8, 255u8, 160u8, 194u8, 134u8, 162u8,
                            135u8, 180u8, 11u8, 237u8, 232u8, 56u8, 181u8, 175u8, 145u8, 107u8,
                            40u8, 232u8, 140u8, 96u8, 29u8, 7u8, 222u8, 146u8, 228u8, 186u8, 87u8,
                            231u8,
                        ]
                    {
                        let call = Sudo {
                ...
                > {
                    if self.client.metadata().call_hash::<SudoUncheckedWeight>()?
                        == [
                            24u8, 61u8, 207u8, 108u8, 15u8, 229u8, 230u8, 113u8, 243u8, 179u8,
                            77u8, 10u8, 94u8, 52u8, 137u8, 140u8, 68u8, 215u8, 167u8, 86u8, 82u8,
                            70u8, 90u8, 56u8, 106u8, 2u8, 217u8, 99u8, 153u8, 215u8, 3u8, 197u8,
                        ]
                    {
                ...
                > {
                    if self.client.metadata().call_hash::<SudoAs>()?
                        == [
                            10u8, 221u8, 241u8, 133u8, 166u8, 130u8, 59u8, 248u8, 73u8, 42u8, 8u8,
                            41u8, 82u8, 248u8, 75u8, 50u8, 93u8, 145u8, 204u8, 215u8, 8u8, 208u8,
                            136u8, 135u8, 73u8, 40u8, 83u8, 171u8, 54u8, 49u8, 127u8, 33u8,
                        ]
                    {
                        let call = SudoAs {
                            who,
        ...
        X: ::subxt::extrinsic::ExtrinsicParams<T>,
    {
        pub fn validate_metadata(&'a self) -> Result<(), ::subxt::MetadataError> {
            if self.client.metadata().metadata_hash(&PALLETS)
                != [
                    38u8, 117u8, 129u8, 52u8, 135u8, 155u8, 132u8, 194u8, 48u8, 82u8, 100u8, 155u8,
                    151u8, 43u8, 204u8, 146u8, 32u8, 109u8, 139u8, 125u8, 112u8, 9u8, 66u8, 166u8,
                    45u8, 112u8, 0u8, 39u8, 160u8, 206u8, 242u8, 244u8,
                ]
            {
